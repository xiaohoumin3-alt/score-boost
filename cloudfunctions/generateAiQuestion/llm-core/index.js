...
// Fallback LLM 客户端
const { FallbackLLM, SingleModelClient, createFallbackClientFromEnv } = require('./fallback-client')
 ...
 * @returns {MiniMaxClient|FallbackLLM} LLM 客户端实例
 */
function createLLMClient(options = {}) {
  ...
  // 检查是否有 fallback 配置（LLM_API_KEY_2 存在表示启用 fallback）
