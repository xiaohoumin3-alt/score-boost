...
- **[docs/architecture/README.md](docs/architecture/README.md)** — 总览：系统全景图、关键发现、修复路线图
- **[docs/architecture/business-architecture.md](docs/architecture/business-architecture.md)** — 业务架构：6大业务域、6条核心流程（含Mermaid图）、14条业务规则
- **[docs/architecture/data-architecture.md](docs/architecture/data-architecture.md)** — 数据架构：18个集合目录、6个数据模型、数据流图、一致性矩阵
- **[docs/architecture/integration-verification.md](docs/architecture/integration-verification.md)** — 集成验证：15个问题清单（P0×3 / P1×4 / P2×5 / P3×3）、修复路线图
